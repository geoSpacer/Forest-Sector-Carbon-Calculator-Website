<%@ Page Language="C#" AutoEventWireup="true" CodeFile="run-landscape-3history.aspx.cs"
    Inherits="run_landscape_3history" %>
    ...
    <div id="mainPageDiv">
        ...
        <div id="mainPageTitle" style="margin-left: 20px">
            <span><a href="javascript:insertContent('stepNotes', 'notesView', 'notesHide')" id="notesView">
                ...
                Hide</a> notes for this step </span>Disturbance and Management History - Landscape
        </div>
        <div id="main">
            <div id="stepNotes" style="display: none">
                This page determines how the landscape you are examining was disturbed and managed in the past. To start with the default regimes for your region of interest, 
                click on the 'Use default' button. Note that this will clear all existing historical regime information. To add a new primary regime element, enter the primary 
                regime characteristics and choose 'Add'. Once a primary regime is in place you may add as many secondary regimes as you like. The 'Primary Regime' is the main 
                reoccurring management action or disturbance and this will occur starting from the Reference Calendar Year selected in simulation characteristics. As regime 
                elements are added, the date ranges of existing regimes will be altered to accommodate the new regime. To remove a regime or set of regimes, check the row(s) 
                you want removed and click the 'Remove Elements' button. To start over click on 'Clear All' button and the regime boxes will be cleared. 
                ...
                Disturbance regimes include harvest (stem only, aboveground, whole tree, and salvage), prescribed fires, and wildfires. To setup a harvest with site preparation fire 
                select a harvest primary regime, prescribed fire for the secondary regime and an offset of 0. For harvests and prescribed fires, the intervals between treatments will 
                be of relatively equal length. Percent disturbed allows one to indicate a part of each stand in the landscape was not affected by the disturbance event. For example, if 
                50% of a stand’s live biomass is cut, then specify Percent Disturbed to be 50%. The remaining part of the stand will not be affected by that disturbance event. Note that 
                this parameter does not mean that 50% of the stands are not harvested! As utilization / severity increases from low to high more of the live carbon is harvested or killed 
                and more is removed by harvest or combustion depending on the disturbance type.</p>

                <p>For wildfire default, the intervals, percent disturbed and severity are based on an analysis of historical trends in the selected region. The wildfire suppression level 
                can be set to either 'total suppression' (no wildfires are generated), 'no suppression' (wildfires are generated at estimated pre-European settlement levels), or 'typical suppression' 
                (wildfires are generated at 2.5x the 'no suppression' fire return interval to simulate the suppressed wildfire of recent history.  For wildfire custom the interval, 
                severity, and size of fires may all be varied from the most likely condition based on the region and elevation class selected.  At this point one may alter the fire 
                interval continuously and shift severity from one of the five classes to another.  Fire size can either be halved or doubled relative to the default value for a region 
                and elevation class.   Bear in mind that fire size is described by a distribution, so doubling fire size will increase the chances of a very large fire, whereas halving 
            ...
            <div id="inputForm">
                ...
                <tr><td>
                    ...
                    &nbsp;<a href="docs/Carbon_Calculator_utilization.pdf"><asp:Image ID="img_help_priUtilzation" runat="server" ImageUrl="~/images/help-about-icon.png" AlternateText="help" /></a>
                    ...
                    <br />
                    <asp:DropDownList ID="ddl_priUtilization" runat="server" style="margin-bottom: 0px">
                    </asp:DropDownList>
                ...
                <td class="formLastDropdown">
                    ...
                    <asp:RequiredFieldValidator ID="valReq_priSeverity" 
                            ...
                            ValidationGroup="priValidators" InitialValue="Select Level" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                    &nbsp;<a href="docs/Carbon_Calculator_Fire_History_Parameterization.pdf"><asp:Image ID="img_help_pri_severity" runat="server" 
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="valRange_secDisturb" runat="server" Enabled="true"
                    ...
                    &nbsp;<a href="docs/Carbon_Calculator_utilization.pdf"><asp:Image ID="img_help_secUtilization" runat="server" ImageUrl="~/images/help-about-icon.png" AlternateText="help" /></a>
                    <br />
                ...
                <td>
                    ...
                    &nbsp;<a href="docs/Carbon_Calculator_Fire_History_Parameterization.pdf"><asp:Image ID="img_help_secSeverity" runat="server" ImageUrl="~/images/help-about-icon.png" AlternateText="help" /></a>
                        <br />
                ...
                <table cellspacing="10px">
                    <tr>
                        ...
                        <td valign="top">
                            <br />
                            <asp:Button ID="btn3_setDefault" CssClass="formButtonSecondary" runat="server" 
                                Text="Use Default" onclick="btn3_setDefault_Click" 
                                 /><br /><br />                            
                            <asp:Button ID="btn3_removeElements" CssClass="formButtonSecondary" runat="server" 
                                Text="Remove Elements" onclick="btn3_removeElements_Click"
                                 /><br /><br />                           
                            <asp:Button ID="btn3_clearAll" CssClass="formButtonSecondary" runat="server" 
                                Text="Clear All" onclick="btn3_clearAll_Click"
                                 />
                ...
                <asp:Button ID="btn3previous" class="formButton" runat="server" Text="Previous" OnClick="btn3previous_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btn3next" class="formButton" runat="server" Text="Next" OnClick="btn3next_Click" />
                </form>
            </div>
        </div>
