...
public partial class run_landscape : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Session["scale"] = "landscape";

            // set grid size for landscape
            Session["simCols"] = 13;
            Session["simRows"] = 20;

            // if management dictionary has records from stand mode, delete records
